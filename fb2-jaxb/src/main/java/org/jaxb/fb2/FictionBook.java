 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="body" type="{http://www.gribuser.ru/xml/fictionbook/2.0}notesBodyType" maxOccurs="unbounded"/&gt;
...
public class FictionBook {
    ...
    @XmlElement(required = true)
    protected List<NotesBodyType> body;
     ...
     * 
     */
    public List<NotesBodyType> getBody() {
        if (body == null) {
            body = new ArrayList<NotesBodyType>();
        }
        return this.body;
    }
